...
* `IntelliJ IDEA <https://www.jetbrains.com/idea/>`__ The Leading IDE for Professional Development in Java and Kotlin. Grab the free communit version.
* `Jetbrains PyCharm <https://www.jetbrains.com/pycharm/>`__ The only Python IDE you need. Built for web, data, and AI/ML professionals. Supercharged with an AI-enhanced IDE experience. Grab the free communit version.
